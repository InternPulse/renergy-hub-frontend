...
```bash
git clone https://github.com/InternPulse/project-x-frontend.git
```
...
1. Clone the repo `git clone https://github.com/InternPulse/project-x-frontend.git`.
2. Open your terminal & set the origin branch: `git remote add origin https://github.com/InternPulse/project-x-frontend.git`
